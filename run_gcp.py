...
def get_node_addresses():
    ip_addresses = ["10.190.0.3", "10.190.0.4", "10.190.0.5", "10.190.0.6", "10.190.0.7"]
    for i in range(1, 6):  # Assume a maximum of 10 nodes
        node_address = f'{ip_addresses[i-1]}:{50050 + i}'
